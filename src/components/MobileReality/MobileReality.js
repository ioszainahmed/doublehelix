...
class MobileReality extends Component {
    ...
    _renderBadge() {
        return `
            <div class="[animation:fadeSlideIn_1s_ease-out_0.2s_both] animate-on-scroll inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/30 bg-purple-500/5 backdrop-blur-sm">
    ...
    _renderHeadline() {
        ...
        return `
            <h2 class="[animation:fadeSlideIn_1s_ease-out_0.4s_both] animate-on-scroll text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight font-manrope leading-[1.1]">
    ...
    render() {
        return `
            <section id="mobile-reality" class="debug-mobile-reality relative py-8 md:py-12 lg:py-16 overflow-hidden">
                ...
                <div class="debug-mobile-reality-bg absolute inset-0 -z-10">
